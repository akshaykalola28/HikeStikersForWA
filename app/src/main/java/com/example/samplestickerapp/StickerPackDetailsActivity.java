...
public class StickerPackDetailsActivity extends AddStickerPackActivity {
    ...
    //Interstitial add
    private InterstitialAd addWAButtonAd;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //TODO: Change AdUnit and remove Test Device
        MobileAds.initialize(this, "ca-app-pub-9415187538460886~1114124599");
        //Banner ad
        AdView mAdView = findViewById(R.id.adView);
        //add test device for testing ** .addTestDevice("890D60DBDAAED0BDB954981B5ECC5B0D")
        AdRequest adRequest = new AdRequest.Builder().build();
        mAdView.loadAd(adRequest);

        addWAButtonAd = new InterstitialAd(this);
        addWAButtonAd.setAdUnitId("ca-app-pub-9415187538460886/7731503836");
        addWAButtonAd.loadAd(new AdRequest.Builder().build());
        backPressAd = new InterstitialAd(this);
        backPressAd.setAdUnitId("ca-app-pub-9415187538460886/9016665344");
        ...
        addButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (addWAButtonAd.isLoaded()) {
                    addWAButtonAd.show();
                    //Toast.makeText(StickerPackDetailsActivity.this, "Ad Show", Toast.LENGTH_SHORT).show();
                    addStickerPackToWhatsApp(stickerPack.identifier,stickerPack.name);
                } else {
                    //Toast.makeText(StickerPackDetailsActivity.this, "Ad not Loaded", Toast.LENGTH_SHORT).show();
                    addStickerPackToWhatsApp(stickerPack.identifier,stickerPack.name);
                }
            }
        });
    ...
    public void onBackPressed() {
        //TODO: Change or add different Ad Unit
        backPressAd.show();
        super.onBackPressed();
    }
